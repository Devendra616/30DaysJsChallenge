...
**Task 1:** ✅ Task 1 : Write a program to print numbers from 1 to 10 using a for loop.

**Task 2:** ✅ Task 2 : Write a program to print the multiplication table of 5 using a for loop.

#### Activity 2: While Loop

**Task 3:** ✅ Task 3 : Write a program to calculate the sum of numbers from 1 to 10 using a while loop.

**Task 4:** ✅ Task 4 : Write a program to print numbers from 10 to 1 using a while loop.

#### Activity 3: Do...While Loop

**Task 5:** ✅ Task 5 : Write a program to print numbers from 1 to 5 using a do while loop.

**Task 6:** ✅ Task 6 : Write a program to calculate the factorial of a number using a do...while loop.

#### Activity 4: Nested Loop

**Task 7:** ✅ Task 7 : Write a program to print a pattern using nested for loops.

#### Activity 5: Loop Control Statements

**Task 8:** ✅ Task 8 : Write a program to print numbers from 1 to 10, but skip the number 5 using the `continue` statement.

**Task 9:** ✅ Task 9 : Write a program to print numbers from 1 to 10, but stop the loop when the number is 7 using the `break` statement.
...
**Task 5:** ✅ Create a custom error class that extends the built-in Error class. Throw an instance of this custom error in a function and handle it using a try-catch block.
...
Closures allow you to create private variables. Only functions within the closure can access them.
Useful for implementing modules or libraries.

#### Callbacks:

Closures are often used for callbacks. Think event listeners or asynchronous operations.
The callback function retains access to its surrounding context.

#### Memoization:

Closures can cache expensive computations.
Example: Fibonacci sequence calculation.

#### Gotchas:

_Memory Leaks:_
Be careful! Closures can keep references to objects, preventing them from being garbage collected.
_Binding Issues:_
Be aware of how this behaves inside closures. It can catch you off guard.
...
- Use closures to create private state and create encapsulated modules.
- Apply closures in practical scenarios like generating unique IDs and memoization.
- Use closures in loops to capture and create variables correctly.
...
**Task 5:** ✅ Implement a Queue class with methods enqueue (add element), dequeue (remove element), and peek (view the front element).

**Task 6:** ✅ Use the Queue class to simulate a simple printer queue `where print jobs are added to the queue and processed in order.

#### Activity 4: Binaay Trees
...
**LocalStorage** is a type of web storage that allows you to store data in the browser with no expiration date. This means the data will persist even after the browser is closed and reopened. It’s useful for storing data that you want to keep available across sessions.

### Key Features

- **Persistence**: Data remains until explicitly deleted.
- **Scope**: Shared across all tabs and windows with the same origin.
- **Capacity**: Typically around 5MB, but this can vary by browser.
...
**SessionStorage** allows you to store data that is only available for the duration of the page session. The data is cleared when the page session ends, such as when the browser tab or window is closed.

### Key Features

- **Persistence**: Data is cleared when the page session ends.
- **Scope**: Specific to the tab or window where it was created.
- **Capacity**: Typically around 5MB, but this can vary by browser.
...
Solutions to the challenges can be found [here](./20.Day20-LocalStorage%20and%20SessionStorage/activites.js).
...
Solutions to the challenges can be found [here](./26.Day26-Chat%20Application/index.html).

### Screenshots

![Chat Application](./26.Day26-Chat%20Application/screenshot1.png)

## Day 27: Project 4 Task Mangement App
...
Solutions to the challenges can be found [here](27.Day27-Task%20Management%20App/index.html).

### Screenshots

![Task Mangement App](./27.Day27-Task%20Management%20App/assets/Screenshot1.png)

![Task Mangement App](./27.Day27-Task%20Management%20App/assets/Screenshot2.png)

![Task Mangement App](./27.Day27-Task%20Management%20App/assets/Screenshot3.png)
...
**Task 3:** ✅ Write a script to dynamically generate the product listing from the product data and display it on the web page. Style the product cards using CSS.
...
Solutions to the challenges can be found [here](./28.Day28-Ecommerce%20Website/index.html).

### Screenshots

![Ecommerce Website](./28.Day28-Ecommerce%20Website/Screenshot1.png)

![Ecommerce Website](./28.Day28-Ecommerce%20Website/Screenshot2.png)
